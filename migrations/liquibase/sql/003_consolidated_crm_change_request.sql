...
DO $$ BEGIN
    IF EXISTS (
        ...
        WHERE table_schema = 'dyno_crm' AND table_name = 'pipeline_stage' AND column_name = 'stage_order'
    ) THEN
        EXECUTE 'ALTER TABLE dyno_crm.pipeline_stage RENAME COLUMN stage_order TO display_order';
    END IF;
END $$;
